...
query_results_file = './rag_evaluation_query_results_top25_text-embedding-3-large.json'
...
for hp_id in expanded_hpo_name_dict:
    ...
    for synonym in expanded_hpo_name_dict[hp_id]:
        ...
        if is_queried:
            continue
        try:
            results = hpo_db.query_hpo(synonym, n_results=25)
...
with open('./rag_evaluation_query_results_top25_text-embedding-3-large.json', 'w') as f:
    json.dump(query_results, f)
    
print("Query results saved to rag_evaluation_query_results_top25_text-embedding-3-large.json")