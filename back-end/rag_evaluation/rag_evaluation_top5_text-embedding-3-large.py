...
query_results_file = './rag_evaluation_query_results_top5_text-embedding-3-large.json'
...
with open('./rag_evaluation_query_results_top5_text-embedding-3-large.json', 'w') as f:
    json.dump(query_results, f)
    
print("Query results saved to rag_evaluation_query_results_top5_text-embedding-3-large.json")